...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "specialty", postgresql.ENUM(name="medicalspecialty", create_type=False), nullable=False
        ),
        sa.Column(
            "difficulty", postgresql.ENUM(name="difficultylevel", create_type=False), nullable=False
        ),
        ...
        sa.Column(
            "requires_australian_context", sa.Boolean(), nullable=False, server_default="true"
        ),
        sa.Column(
            "created_at",
            sa.DateTime(timezone=True),
    ...
    op.create_table(
        ...
        sa.Column(
            "station_type", postgresql.ENUM(name="oscetype", create_type=False), nullable=False
        ),
