...
def analyze_citations():
    ...
    total_with_ref = (stats['talley_with_page'] + stats['murtagh_with_page'] +
                      stats['etg_with_section'] + stats['oxford_with_page'] +
                      stats['amc_with_page'])
    print(f"   {'='*30}")
    ...
    total_generic = (stats['talley_without_page'] + stats['murtagh_without_page'] +
                     stats['etg_without_section'] + stats['oxford_without_page'] +
