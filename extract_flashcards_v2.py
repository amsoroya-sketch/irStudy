...
class FlashcardExtractor:
        ...
        for pattern in patterns:
            for match in re.finditer(pattern, text, re.IGNORECASE):
                ...
                explanation = (
                    ...
                    if exp_match
                    else "Requires immediate recognition and action"
                )
        ...
        for pattern in phrase_patterns:
            for match in re.finditer(pattern, text):
                ...
                if any(
                    ...
                    for word in ["you", "i", "we", "your", "understand", "feel", "sorry"]
                ):
                    self.add_card(
                        "communication",
    ...
    def extract_img_mistakes(self, text, file_path):
        ...
        for section in mistake_sections:
            ...
            for mistake in mistakes:
                ...
                self.add_card(
                    "img_mistakes", front, back, deck, ["img-mistake", "avoid"], file_path.name
                )
    ...
    def process_all(self):
        ...
        files = [
            f for f in files if f.stem not in ["00_MASTER_INDEX_AMC_CLINICAL_OSCE", "START_HERE"]
        ]
...
def main():
    ...
    extractor.save(
        Path("/home/dev/Development/irStudy/ICRP_Program_Resources/Flashcards/flashcard_data.json")
    )
