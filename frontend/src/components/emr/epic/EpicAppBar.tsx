/**
 * Epic AppBar Component
 *
 * Top navigation bar with Epic branding, patient context, and session controls.
 *
 * Features:
 * - Epic logo and system identification
 * - Patient context (name, MRN)
 * - Auto-save status indicator
 * - Session action buttons (Save, Submit, Exit)
...
export const EpicAppBar: React.FC<EpicAppBarProps> = ({
  patient,
  onSave,
  onSubmit,
  onExit,
