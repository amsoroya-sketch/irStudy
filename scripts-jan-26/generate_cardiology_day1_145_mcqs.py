#!/usr/bin/env python3
"""
Generate Cardiology MCQs - Day 1 (145 MCQs)
...
try:
    ...
    print(f"ERROR: Could not import CardiologyExpert from src/agents/medical/med_001_cardiology.py")
...
DAY = 1
TARGET_COUNT = 145
OUTPUT_FILE = "data-jan-26/mcqs/cardiology_day1_145_mcqs.json"
LOG_FILE = "data-jan-26/validation/day1_cardiology_log.txt"

# Topics for Day 1
TOPICS = [
    {"name": "STEMI", "count": 25, "keywords": ["STEMI", "ST elevation", "myocardial infarction", "troponin", "ECG"]},
    {"name": "NSTEMI", "count": 25, "keywords": ["NSTEMI", "non-ST elevation", "ACS", "troponin", "unstable angina"]},
    {"name": "Unstable Angina", "count": 20, "keywords": ["unstable angina", "chest pain", "cardiac", "angina"]},
    {"name": "MI Management", "count": 30, "keywords": ["MI management", "PCI", "thrombolysis", "antiplatelet", "MONA"]},
    {"name": "Thrombolysis", "count": 20, "keywords": ["thrombolysis", "fibrinolysis", "streptokinase", "alteplase"]},
    {"name": "PCI", "count": 25, "keywords": ["PCI", "percutaneous coronary intervention", "angioplasty", "stent"]},
]
...
class MCQGenerator:
    ...
    def __init__(self):
        ...
        try:
            ...
            self.log("✓ LLM Service operational (deepseek-r1:7b)")
        except Exception as e:
    ...
    def check_rag_operational(self):
        ...
        try:
            ...
            data = response.json()
            # Qdrant returns 'points_count', not 'vectors_count'
    ...
    def fetch_rag_citations(self, topic, keywords, retry_count=0):
        ...
        try:
            ...
            results = self.qdrant.search(
                ...
                limit=5
                # Note: No filter - search all sources (ECG book.pdf, etc.)
            )
...
7. For cardiology topics, include relevant:
   - ECG findings if applicable
   - Biomarker values (troponin, CK-MB, BNP)
   - GRACE/TIMI scores if ACS
...
"""
        ...
        try:
            ...
            mcq_data['metadata'] = {
                ...
                "tools_applied": ["ECG_interpretation", "GRACE_score", "TIMI_risk"]
            }
    ...
    def generate_all(self):
        ...
        self.log(f"\n{'='*60}")
        self.log(f"CARDIOLOGY DAY 1 GENERATION (Agent: {AGENT_ID})")
