...
def convert_markdown_to_html(md_content):
    ...
    html = re.sub(
        r"RED FLAG",
        r'<span style="color: #e74c3c; font-weight: bold;">🚨 RED FLAG</span>',
        html,
        flags=re.IGNORECASE,
    )
    html = re.sub(
        r"URGENT",
        r'<span style="color: #e74c3c; font-weight: bold;">URGENT</span>',
        html,
        flags=re.IGNORECASE,
    )
    html = re.sub(
        r"EMERGENCY",
        r'<span style="color: #e74c3c; font-weight: bold;">⚠️ EMERGENCY</span>',
        html,
        flags=re.IGNORECASE,
    )
