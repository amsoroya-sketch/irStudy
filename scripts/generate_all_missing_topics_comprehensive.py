...
class ComprehensiveTopicEngine:
    ...
    def __init__(self):
        ...
        self.topic_categories = {
            'Endocrine & Metabolic': {
                ...
                'topics': [
                    {'name': 'Hyperthyroidism', 'mcq_count': 15, 'image_type': 'Thyroid_Function_Tests'},
                    {'name': 'Hypothyroidism', 'mcq_count': 15, 'image_type': 'Thyroid_Function_Tests'},
                    {'name': 'DKA (Diabetic Ketoacidosis)', 'mcq_count': 15, 'image_type': 'ABG_Glucose'},
                    {'name': 'Hypoglycemia', 'mcq_count': 15, 'image_type': 'Glucose_Chart'},
                    {'name': 'Diabetic Neuropathy', 'mcq_count': 12, 'image_type': 'Neurological_Exam'},
                    {'name': 'Thyroid Nodules', 'mcq_count': 12, 'image_type': 'Thyroid_Ultrasound'},
                    {'name': 'Adrenal Disorders', 'mcq_count': 12, 'image_type': 'Cortisol_Tests'},
                    {'name': 'Pituitary Disorders', 'mcq_count': 12, 'image_type': 'Hormone_Levels'}
                ]
            },
            'Syncope & Falls': {
                'specialty': 'Cardiology',
                'topics': [
                    {'name': 'Syncope Approach and Structure', 'mcq_count': 15, 'image_type': 'ECG'},
                    {'name': 'Fall Assessment and Structure', 'mcq_count': 15, 'image_type': 'Assessment_Form'},
                    ...
                    {'name': 'Carotid Sinus Hypersensitivity', 'mcq_count': 8, 'image_type': 'Carotid_Massage'},
            ...
            'General Medicine': {
                ...
                'topics': [
                    {'name': 'GORD (Gastro-esophageal Reflux)', 'mcq_count': 12, 'image_type': 'Endoscopy'},
                    {'name': 'Shingles (Herpes Zoster)', 'mcq_count': 12, 'image_type': 'Dermatological_Photo'},
                    {'name': 'OSA (Obstructive Sleep Apnea)', 'mcq_count': 15, 'image_type': 'Sleep_Study'},
                    ...
                    {'name': 'Infective Endocarditis', 'mcq_count': 15, 'image_type': 'Blood_Culture'},
                    {'name': 'Post-operative Fever', 'mcq_count': 12, 'image_type': 'Temperature_Chart'},
                    {'name': 'Post-operative SOB', 'mcq_count': 12, 'image_type': 'CXR'},
                    {'name': 'Lung Cancer', 'mcq_count': 15, 'image_type': 'CT_Chest'},
                    {'name': 'Fatigue and Tiredness Approach', 'mcq_count': 12, 'image_type': 'Investigation_Flow'},
                    {'name': 'Travel Medicine Infections', 'mcq_count': 12, 'image_type': 'Laboratory'},
                    {'name': 'Drug Toxicity and Overdose', 'mcq_count': 12, 'image_type': 'Toxicology_Screen'}
                ]
            },
            'GI & Electrolytes': {
                'specialty': 'Gastroenterology',
                'topics': [
                    {'name': 'Acute Abdomen Approach', 'mcq_count': 15, 'image_type': 'Abdominal_Xray'},
                    ...
                    {'name': 'Dehydration Assessment', 'mcq_count': 10, 'image_type': 'Clinical_Assessment'},
                    {'name': 'Constipation and Diarrhea', 'mcq_count': 12, 'image_type': 'Bristol_Stool_Chart'}
                ]
            },
            'Neurology': {
                'specialty': 'Neurology',
                'topics': [
                    {'name': 'Dizziness and Vertigo Cluster', 'mcq_count': 15, 'image_type': 'Dix_Hallpike'},
                    ...
                    {'name': 'Peripheral Neuropathy', 'mcq_count': 12, 'image_type': 'Nerve_Conduction'},
    ...
    def generate_content_for_topic(self, topic_data: Dict, category: str, specialty: str,
                                   global_mcq_num: int, global_osce_num: int,
                                   global_card_num: int) -> Dict[str, Any]:
        ...
        study_card = {
            ...
            'category': category,
            'front': {
                'question': f"What are the key points about {topic_name}?"
            },
            'back': {
        ...
        for category, data in self.topic_categories.items():
            ...
            for topic_data in topics:
                ...
                result = self.generate_content_for_topic(
                    topic_data, category, specialty,
                    global_mcq_num, global_osce_num, global_card_num
                )
    ...
    def print_summary(self):
        ...
        for category, stats in self.stats['by_category'].items():
            print(f"  {category}:")
            print(f"    Topics: {stats['topics']}, MCQs: {stats['mcqs']}, OSCEs: {stats['osces']}, Cards: {stats['cards']}")
