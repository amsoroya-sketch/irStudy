...
c("🚨 RED FLAG: Massive haematemesis immediate management",
  ...
  "red_flags", "hard", MG, "Medicine/02_GI_Bleeding_Differentials.html")

c("Differentials: Causes of melaena (black tarry stool)",
  "• Peptic ulcer (most common)\n• Oesophageal varices\n• Mallory-Weiss tear\n• Gastritis\n• Upper GI malignancy\n• Aorto-enteric fistula (if AAA repair history)",
  "differential", "medium", MG, "Medicine/02_GI_Bleeding_Differentials.html")

c("IMG Mistake: Not calculating Rockall score in upper GI bleed",
  ...
  "img_mistake", "medium", MG, "Medicine/02_GI_Bleeding_Differentials.html")

c("Australian: Upper GI endoscopy timing (eTG guidelines)",
  ...
  "australian", "medium", MG, "Medicine/02_GI_Bleeding_Differentials.html")

# Cardiorespiratory (continued)
c("🚨 RED FLAG: Cardiac tamponade (Beck's triad)",
  "Hypotension + raised JVP + muffled heart sounds + pulsus paradoxus → URGENT pericardiocentesis (echo-guided)",
  "red_flags", "hard", MC, "Medicine/01_Cardiovascular_Respiratory_History.html")

c("🚨 RED FLAG: Acute severe asthma (life-threatening features)",
...
c("Differentials: Chronic cough causes (>8 weeks)",
  "• Post-nasal drip (upper airway cough syndrome)\n• Asthma/eosinophilic bronchitis\n• GORD\n• ACE inhibitor\n• Chronic bronchitis\n• Bronchiectasis\n• Lung cancer",
  "differential", "medium", MC, "Medicine/01_Cardiovascular_Respiratory_History.html")

c("Physical exam: Differentiating pleural effusion vs consolidation",
  ...
  "physical_exam", "medium", MC, "Medicine/02_Physical_Examination_Cardiovascular_Respiratory.html")

c("Australian: Oxygen prescribing in COPD",
  ...
  "australian", "medium", MC, "Medicine/01_Cardiovascular_Respiratory_History.html")

# Neurology (continued)
c("🚨 RED FLAG: Bacterial meningitis empirical treatment",
  ...
  "red_flags", "hard", MN, "Medicine/03_Neurology_Headache_Differentials.html")

c("Differentials: Causes of headache + fever",
  "• Meningitis (bacterial, viral, fungal)\n• Encephalitis\n• Brain abscess\n• Sinusitis\n• Viral illness (influenza)\n• Malaria (if returned traveler)",
  "differential", "hard", MN, "Medicine/03_Neurology_Headache_Differentials.html")

c("Physical exam: Kernig's sign vs Brudzinski's sign",
  ...
  "physical_exam", "medium", MN, "Medicine/03_Neurology_Headache_Differentials.html")

c("IMG Mistake: Giving steroids before LP in suspected meningitis",
  ...
  "img_mistake", "medium", MN, "Medicine/03_Neurology_Headache_Differentials.html")

c("🚨 RED FLAG: Stroke thrombolysis timeframe",
  ...
  "red_flags", "hard", MN, "Medicine/04_Neurology_Weakness_Limb_Examination.html")

c("Physical exam: FAST (stroke recognition)",
  "F = Face (facial droop)\nA = Arms (arm drift)\nS = Speech (slurred, unable to speak)\nT = Time (call 000 immediately)\nPositive FAST → Stroke until proven otherwise",
  "physical_exam", "hard", MN, "Medicine/04_Neurology_Weakness_Limb_Examination.html")

c("Differentials: Acute unilateral weakness causes",
  "• Stroke (most common)\n• Todd's paresis (post-ictal)\n• Hemiplegic migraine\n• Hypoglycaemia\n• Functional (conversion disorder)\n• Subdural haematoma\n• Brain tumor",
  "differential", "hard", MN, "Medicine/04_Neurology_Weakness_Limb_Examination.html")

# Emergency Medicine
c("🚨 RED FLAG: Rhabdomyolysis and acute kidney injury",
  ...
  "red_flags", "hard", MEM, "Medicine/10_Emergency_Anaphylaxis_Management.html")

c("Australian: Snake bite management (Australian snakes)",
  ...
  "australian", "medium", MEM, "Emergency medicine")

c("🚨 RED FLAG: Status epilepticus treatment protocol",
  ...
  "red_flags", "hard", MEM, "Medicine/12_Emergency_Seizure_Management.html")

c("Differentials: Causes of seizures (first presentation)",
  ...
  "differential", "medium", MEM, "Medicine/12_Emergency_Seizure_Management.html")

c("Australian: Seizure driving restrictions (NSW)",
  ...
  "australian", "hard", MEM, "Medicine/12_Emergency_Seizure_Management.html")

# Endocrinology
c("🚨 RED FLAG: DKA diagnostic criteria",
  ...
  "red_flags", "hard", ME, "Medicine/09_Endocrinology_Diabetes_Management.html")

c("🚨 RED FLAG: Hyperosmolar hyperglycaemic state (HHS)",
...
c("Differentials: Causes of hypoglycaemia",
  ...
  "differential", "medium", ME, "Medicine/09_Endocrinology_Diabetes_Management.html")

c("Australian: Continuous glucose monitoring (CGM) PBS access",
  ...
  "australian", "easy", ME, "Medicine/09_Endocrinology_Diabetes_Management.html")

c("IMG Mistake: Not checking for DKA in hyperglycaemia",
  ...
  "img_mistake", "medium", ME, "Medicine/09_Endocrinology_Diabetes_Management.html")

# ENT
c("Physical exam: Otoscopy - normal tympanic membrane landmarks",
  ...
  "physical_exam", "easy", MENT, "Medicine/05_Physical_Examination_ENT.html")

c("🚨 RED FLAG: Acute epiglottitis",
  ...
  "red_flags", "hard", MENT, "Medicine/05_Physical_Examination_ENT.html")

c("Differentials: Causes of vertigo",
  ...
  "differential", "medium", MENT, "Medicine/05_Physical_Examination_ENT.html")

c("Physical exam: Dix-Hallpike test (BPPV diagnosis)",
  ...
  "physical_exam", "medium", MENT, "Medicine/05_Physical_Examination_ENT.html")

c("IMG Mistake: Not differentiating peripheral vs central vertigo",
  ...
  "img_mistake", "medium", MENT, "Medicine/05_Physical_Examination_ENT.html")

# Cardiology/ECG
c("Physical exam: ECG - STEMI territory localization",
  ...
  "physical_exam", "hard", MCARD, "Medicine/11_ECG_Interpretation_Guide.html")

c("🚨 RED FLAG: Wellens' syndrome (LAD occlusion warning)",
  ...
  "red_flags", "hard", MCARD, "Medicine/11_ECG_Interpretation_Guide.html")

c("Differentials: Causes of atrial fibrillation",
  ...
  "differential", "medium", MCARD, "Medicine/11_ECG_Interpretation_Guide.html")

c("Australian: CHADS-VASc score for AF anticoagulation",
  ...
  "australian", "medium", MCARD, "Medicine/11_ECG_Interpretation_Guide.html")

c("IMG Mistake: Not recognizing posterior MI",
  ...
  "img_mistake", "hard", MCARD, "Medicine/11_ECG_Interpretation_Guide.html")

# ==================================================================
# SURGERY - Expanded Content
# ==================================================================

c("Physical exam: Abdominal examination - McBurney's point",
  ...
  "physical_exam", "easy", SUR, "Surgery/02_Acute_Abdomen_Physical_Examination.html")

c("Physical exam: Rovsing's sign",
...
c("Differentials: Causes of bowel obstruction",
  ...
  "differential", "medium", SUR, "Surgery/01_Acute_Abdomen_History_Differentials.html")

c("🚨 RED FLAG: Closed loop obstruction",
  ...
  "red_flags", "hard", SUR, "Surgery/01_Acute_Abdomen_History_Differentials.html")

c("Australian: Surgical consent documentation",
  ...
  "australian", "medium", SUR, "Surgery/04_Pre_Post_Operative_Assessment.html")

c("IMG Mistake: Not recognizing post-operative ileus",
  ...
  "img_mistake", "medium", SUR, "Surgery/04_Pre_Post_Operative_Assessment.html")

# Lumps and hernias
c("Physical exam: Examining a lump - 7 characteristics",
  ...
  "physical_exam", "medium", SUR, "Surgery/03_Surgical_Lumps_Hernias_History_Examination.html")

c("Physical exam: Transillumination test",
  ...
  "physical_exam", "easy", SUR, "Surgery/03_Surgical_Lumps_Hernias_History_Examination.html")

c("Differentials: Groin lump differentials",
  "• Inguinal hernia (most common)\n• Femoral hernia\n• Lymph node (lymphadenopathy)\n• Saphena varix\n• Lipoma\n• Undescended/ectopic testis\n• Psoas abscess",
  "differential", "medium", SUR, "Surgery/03_Surgical_Lumps_Hernias_History_Examination.html")

c("Physical exam: Inguinal vs femoral hernia differentiation",
...
c("IMG Mistake: Missing breast cancer red flags",
  ...
  "img_mistake", "hard", SUR, "Surgery/03_Surgical_Lumps_Hernias_History_Examination.html")

# Trauma
c("Physical exam: Log roll examination technique",
  ...
  "physical_exam", "medium", SUR, "Surgery/05_Trauma_Assessment.html")

c("🚨 RED FLAG: Pelvic fracture with haemodynamic instability",
  ...
  "red_flags", "hard", SUR, "Surgery/05_Trauma_Assessment.html")

c("Differentials: Causes of shock in trauma",
  "• Haemorrhagic (most common - external bleeding, internal bleeding)\n• Tension pneumothorax\n• Cardiac tamponade\n• Neurogenic (spinal cord injury - bradycardia + hypotension)\n• Septic (rare acutely)",
  "differential", "hard", SUR, "Surgery/05_Trauma_Assessment.html")

c("Australian: Major trauma criteria (NSW)",
  ...
  "australian", "medium", SUR, "Surgery/05_Trauma_Assessment.html")

# ==================================================================
# OBGYN - Expanded Content
# ==================================================================

c("🚨 RED FLAG: Ruptured ectopic pregnancy management",
  ...
  "red_flags", "hard", OG, "ObGyn/01_Obstetric_History_Differentials.html")

c("Differentials: Causes of miscarriage (pregnancy loss <20 weeks)",
  "• Chromosomal abnormalities (50%)\n• Maternal factors (uterine anomalies, cervical incompetence, antiphospholipid syndrome)\n• Infections (rare)\n• Idiopathic (often no cause found)",
  "differential", "medium", OG, "ObGyn/01_Obstetric_History_Differentials.html")

c("Physical exam: Obstetric abdominal palpation - Leopold's maneuvers",
  ...
  "physical_exam", "medium", OG, "ObGyn/04_Obstetric_Examination.html")

c("Australian: Antenatal screening (public system)",
  ...
  "australian", "easy", OG, "ObGyn/01_Obstetric_History_Differentials.html")

c("IMG Mistake: Not recognizing placenta praevia risk factors",
  ...
  "img_mistake", "hard", OG, "ObGyn/01_Obstetric_History_Differentials.html")

# Gynaecological
c("Physical exam: Speculum examination steps",
  ...
  "physical_exam", "medium", OG, "ObGyn/05_Gynaecological_Examination.html")

c("🚨 RED FLAG: Cervical cancer clinical features",
  ...
  "red_flags", "hard", OG, "ObGyn/02_Gynaecological_History_Differentials.html")

c("Australian: National Cervical Screening Program",
  ...
  "australian", "medium", OG, "ObGyn/02_Gynaecological_History_Differentials.html")

c("Communication: Explaining Mirena (hormonal IUS) to patient",
  ...
  "communication", "medium", OG, "ObGyn/03_Contraception_Counselling.html")

# ==================================================================
# PSYCHIATRY - Expanded Content
# ==================================================================

c("Physical exam: Mini-Mental State Examination (MMSE) scoring",
  ...
  "physical_exam", "medium", PSY, "Psychiatry/02_Mental_State_Examination.html")

c("Differentials: Causes of delirium (acute confusion)",
  ...
  "differential", "medium", PSY, "Psychiatry/04_Common_Psychiatric_Presentations.html")

c("🚨 RED FLAG: Lithium toxicity",
  ...
  "red_flags", "hard", PSY, "Psychiatry/04_Common_Psychiatric_Presentations.html")

c("Australian: Mental Health Treatment Plan (MHTP)",
  ...
  "australian", "easy", PSY, "Psychiatry/04_Common_Psychiatric_Presentations.html")

c("Communication: De-escalation techniques for agitated patient",
  ...
  "communication", "medium", PSY, "Psychiatry/03_Risk_Assessment_Suicide_Violence_Selfneglect.html")

c("IMG Mistake: Not documenting capacity assessment properly",
  ...
  "img_mistake", "medium", PSY, "Psychiatry/05_Capacity_Assessment_Legal_Framework.html")

# ==================================================================
# PAEDIATRICS - Expanded Content
# ==================================================================

c("🚨 RED FLAG: Sepsis in children (warning signs)",
  ...
  "red_flags", "hard", PAED, "Paediatrics/02_Common_Paediatric_Presentations.html")

c("Physical exam: Assessing dehydration in children (clinical signs)",
  ...
  "physical_exam", "medium", PAED, "Paediatrics/02_Common_Paediatric_Presentations.html")

c("Differentials: Causes of croup vs epiglottitis vs bacterial tracheitis",
  ...
  "differential", "hard", PAED, "Paediatrics/02_Common_Paediatric_Presentations.html")

c("Australian: Paediatric early warning tool (PEWS)",
  ...
  "australian", "medium", PAED, "Paediatrics/03_Paediatric_Physical_Examination.html")

c("Communication: Explaining vaccination to hesitant parents",
  ...
  "communication", "medium", PAED, "Paediatrics/05_Parent_Communication_Strategies.html")

c("IMG Mistake: Not recognizing bronchiolitis severity",
  ...
  "img_mistake", "medium", PAED, "Paediatrics/02_Common_Paediatric_Presentations.html")

# Developmental milestones (high-yield)
c("Physical exam: Developmental milestones - 6 months",
  ...
  "physical_exam", "medium", PAED, "Paediatrics/04_Developmental_Assessment.html")

c("Physical exam: Developmental milestones - 12 months",
...
c("Physical exam: Developmental milestones - 2 years",
...
c("Communication: Responding to 'How long do I have?' (palliative)",
  ...
  "communication", "hard", ETH, "Ethics_Communication/02_Breaking_Bad_News_Additional_Scenarios.html")

c("Communication: Discussing DNR (Do Not Resuscitate) orders",
  ...
  "communication", "hard", ETH, "Ethics_Communication/01_Communication_Skills_Role_Play_Scripts.html")

c("IMG Mistake: Breaking bad news without warning shot",
  ...
  "img_mistake", "medium", ETH, "Ethics_Communication/02_Breaking_Bad_News_Additional_Scenarios.html")

c("Communication: Responding to denial after bad news",
  ...
  "communication", "medium", ETH, "Ethics_Communication/04_Comprehensive_Emotional_Reactions_Handbook.html")

c("Australian: Advance Care Directives (ACD) in NSW",
  ...
  "australian", "medium", ETH, "Ethics_Communication/01_Communication_Skills_Role_Play_Scripts.html")

c("IMG Mistake: Using family as interpreters",
  ...
  "img_mistake", "medium", ETH, "Ethics_Communication/05_Cultural_Variations_Breaking_Bad_News_Australia.html")

# ==================================================================
# GENERAL OSCE SKILLS
# ==================================================================

c("Communication: OSCE opening (general framework)",
  ...
  "communication", "easy", GEN, "General OSCE skills")

c("Communication: OSCE closing (general framework)",
...
c("IMG Mistake: Poor time management in OSCE",
  ...
  "img_mistake", "medium", GEN, "General OSCE skills")

c("Australian: Australian healthcare structure (Medicare)",
  ...
  "australian", "easy", GEN, "General knowledge")
