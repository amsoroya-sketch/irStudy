...
def get_deck(file_path):
    """Get deck from path"""
    p = str(file_path)
    if "Cardio" in p or "Respiratory" in p:
        return "Medicine_Cardiorespiratory"
    if "GI" in p or "Abdominal" in p:
        return "Medicine_Gastroenterology"
    if "Neuro" in p:
        return "Medicine_Neurology"
    if "Endocrin" in p or "Diabetes" in p:
        return "Medicine_Endocrinology"
    if "ECG" in p:
        return "Medicine_Cardiology"
    if "Emergency" in p or "Anaphylaxis" in p or "Seizure" in p:
...
def extract_all():
    ...
    add(
        "🚨 RED FLAG: Mesenteric ischaemia pain out of proportion",
    ...
    add(
        "Australian: Acute cholecystitis antibiotic choice (eTG)",
    ...
    add(
        "IMG Mistake: Not doing pregnancy test in all women 15-50",
    ...
    add(
        "IMG Mistake: Discharging 'gastroenteritis' without red flag screening",
    ...
    add(
        "Differentials: Central abdominal pain causes",
    ...
    add(
        "Differentials: Suprapubic pain causes",
    ...
    add(
        "IMG Mistake: Not checking for peritonism systematically",
    ...
    add(
        "🚨 RED FLAG: Tension pneumothorax clinical features",
    ...
    add(
        "🚨 RED FLAG: Massive PE presentation",
    ...
    add(
        "Differentials: Acute dyspnoea causes",
    ...
    add(
        "Differentials: Chest pain (cardiac vs non-cardiac)",
    ...
    add(
        "Australian: Troponin interpretation in Australia",
    ...
    add(
        "IMG Mistake: Missing aortic dissection in chest pain",
    ...
    add(
        "Physical exam: Upper motor neuron vs lower motor neuron signs",
    ...
    add(
        "Physical exam: MRC power grading scale",
    ...
    add(
        "🚨 RED FLAG: Guillain-Barré syndrome (acute ascending paralysis)",
    ...
    add(
        "🚨 RED FLAG: Myasthenia gravis crisis",
    ...
    add(
        "Differentials: Acute limb weakness causes",
    ...
    add(
        "🚨 RED FLAG: Massive haemorrhage in trauma",
    ...
    add(
        "Physical exam: ATLS primary survey (ABCDE)",
    ...
    add(
        "Physical exam: FAST scan in trauma",
    ...
    add(
        "Australian: Trauma transfer criteria (NSW)",
    ...
    add(
        "IMG Mistake: Not maintaining C-spine immobilization",
    ...
    add(
        "🚨 RED FLAG: Postmenopausal bleeding (PMB)",
    ...
    add(
        "🚨 RED FLAG: Post-coital bleeding (PCB)",
    ...
    add(
        "Differentials: Heavy menstrual bleeding (HMB) causes",
    ...
    add(
        "Differentials: Acute pelvic pain in women",
    ...
    add(
        "Australian: Contraception PBS restrictions",
    ...
    add(
        "IMG Mistake: Not recognizing PCB as red flag",
    ...
    add(
        "Physical exam: MSE (Mental State Examination) components",
    ...
    add(
        "Physical exam: Assessing suicidal risk in MSE",
    ...
    add(
        "Differentials: Psychosis differential diagnosis",
    ...
    add(
        "Communication: Responding to delusions",
    ...
    add(
        "Australian: Mental Health Act (NSW)",
    ...
    add(
        "🚨 RED FLAG: Non-accidental injury (NAI) red flags",
    ...
    add(
        "Differentials: Fever without focus in children",
    ...
    add(
        "Australian: Paediatric immunization schedule",
    ...
    add(
        "Communication: Explaining febrile convulsion to parents",
    ...
    add(
        "Communication: Breaking bad news - SPIKES framework",
    ...
    add(
        "Communication: Warning shot before bad news",
    ...
    add(
        "Communication: Responding to anger",
    ...
    add(
        "Communication: Responding to tears/sadness",
    ...
    add(
        "IMG Mistake: Using medical jargon without explaining",
    ...
    add(
        "🚨 RED FLAG: Anaphylaxis immediate management",
    ...
    add(
        "Australian: Anaphylaxis adrenaline dose (ANZCOR)",
    ...
    add(
        "Australian: EpiPen prescription",
    ...
    add(
        "IMG Mistake: Giving IV adrenaline instead of IM",
    ...
    add(
        "Communication: Anaphylaxis discharge advice",
    ...
    add(
        "Physical exam: ECG systematic interpretation (DR ABCDEs)",
    ...
    add(
        "Differentials: ST elevation causes",
    ...
    add(
        "Australian: Diabetes medications PBS restrictions",
    ...
    add(
        "Australian: NDSS (National Diabetes Services Scheme)",
    ...
    add(
        "Communication: Explaining Type 2 diabetes diagnosis",
    ...
    add(
        "Physical exam: ASA classification",
    ...
    add(
        "Australian: Surgical category (Australian triage)",
    ...
    add(
        "Australian: VTE prophylaxis guidelines",
    ...
    add(
        "IMG Mistake: Not documenting informed consent",
    ...
    add(
        "Australian: Emergency contraception access",
    ...
    add(
        "Communication: Contraception counselling framework",
    ...
    add(
        "IMG Mistake: Not screening for COCP contraindications",
    ...
    add(
        "Physical exam: Capacity assessment (4 components)",
    ...
    add(
        "Australian: Guardianship Tribunal (NSW)",
    ...
    add(
        "Communication: Assessing capacity - USE AND WEIGH",
    ...
    add(
        "Physical exam: Developmental domains (4 areas)",
    ...
    add(
        "Physical exam: Red flags for developmental delay",
    ...
    add(
        "Communication: Discussing developmental concerns with parents",
    ...
    add(
        "Communication: Cultural sensitivity in bad news",
    ...
    add(
        "IMG Mistake: Direct bad news delivery without preparation",
    ...
    add(
        "Australian: Medicare and specialist referrals",
    ...
    add(
        "Australian: After-hours GP services",
    ...
    add(
        "Communication: Safety-netting (red flags for patients)",
    ...
    add(
        "IMG Mistake: Not addressing patient's health literacy",
    ...
    add(
        "IMG Mistake: Inadequate pain management",
    ...
    add(
        "🚨 RED FLAG: Sepsis recognition (qSOFA)",
    ...
    add(
        "🚨 RED FLAG: Hypoglycaemia management",
        ...
        "red_flags",
        "medium",
        "Medicine_Endocrinology",
        "Diabetes emergencies",
    )

    add(
        "Differentials: Confusion/delirium causes (surgical patients)",
    ...
    add(
        "Differentials: Collapse/syncope causes",
        ...
        "differential",
        "medium",
        "Medicine_Cardiorespiratory",
        "Syncope assessment",
    )

    add(
        "Physical exam: Fundoscopy - hypertensive retinopathy grading",
    ...
    add(
        "Physical exam: Respiratory examination - percussion notes",
    ...
    add(
        "Australian: Notifiable diseases (NSW)",
    ...
    add(
        "Australian: Workplace injury (WorkCover NSW)",
    ...
    add(
        "Australian: Medical certificates (sick leave)",
    ...
    add(
        "Communication: Breaking bad news to non-English speaker",
    ...
    add(
        "Communication: Obtaining consent for procedure",
    ...
    add(
        "IMG Mistake: Not exploring patient's ICE (Ideas, Concerns, Expectations)",
    ...
    add(
        "IMG Mistake: Closing consultation abruptly",
