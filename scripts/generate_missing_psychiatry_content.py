...
class MissingPsychiatryContentEngine:
    ...
    def generate_osce(self, topic_data: Dict, osce_num: int) -> Dict[str, Any]:
        ...
        osce = {
            ...
            "assessment_tools": [
                {"type": "MSE", "description": "Mental Status Examination"},
                {"type": "Rating_Scale", "description": f"Rating scale for {topic}"},
            ],
            "references": citations,
            "created_date": datetime.now().isoformat(),
        }
    ...
    def generate_study_card(self, topic_data: Dict, card_num: int) -> Dict[str, Any]:
        ...
        card = {
            ...
            "front": {"question": f"What are the key points about {topic}?"},
            "back": {
