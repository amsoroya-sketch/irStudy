...
# Confirmation text
doc.add_paragraph('This is to confirm that the above-named individual is currently undertaking a Hepatitis B vaccination course in accordance with NSW Health Occupational Assessment, Screening and Vaccination (OASV) requirements.')
...
doc.add_paragraph('All remaining doses and post-vaccination serology will be completed within recommended timeframes, and documentary evidence will be provided to NSW Health.')
